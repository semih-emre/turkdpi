...
Depends: curl, libnetfilter-queue1, network-manager, nftables, pkexec, qml6-module-qtqml-workerscript, qml6-module-qtquick, qml6-module-qtquick-controls, qml6-module-qtquick-layouts, qt6-qpa-plugins
